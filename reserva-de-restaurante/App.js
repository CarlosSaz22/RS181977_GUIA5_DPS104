...
const reservaFiltradas = reservas.filter( reservas => reservas.id !== id );
setReservas( reservaFiltradas );
guardarReservasStorage(JSON.stringify(reservaFiltradas));
}
...
// Almacenar las reserva en storage
